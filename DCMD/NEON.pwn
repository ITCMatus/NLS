...
/**************************************************************************************************************************************/
	#define dcmd(%1,%2,%3) if ((strcmp((%3)[1], #%1, true, (%2)) == 0) && ((((%3)[(%2) + 1] == 0) && (dcmd_%1(playerid, "")))||(((%3)[(%2) + 1] == 32) && (dcmd_%1(playerid, (%3)[(%2) + 2]))))) return 1  //http://forum.sa-mp.com/showthread.php?t=48239
/**************************************************************************************************************************************/
	#define DIALOG_NEON   0
	#define DIALOG_SVETLO 1 
	#define DIALOG_MENU   2
/**************************************************************************************************************************************/
	#define FARBA_CERVENA 0xFF000000
/**************************************************************************************************************************************/
	new 
		NEONY  [MAX_PLAYERS],
		SVETLA [MAX_PLAYERS];
	        ...
	        if(response){
	            ...
	            switch (listitem){
	            	...
	            	case 1:{ 
	            		...
	            		ShowPlayerDialog(playerid, DIALOG_SVETLO, DIALOG_STYLE_LIST,
							"TUNING - SVETL¡", 
								"MODR›   " "\n"\
	            				"ZELEN›  " "\n"\
	            				"BIELY   " "\n"\
...
/**************************************************************************************************************************************/
	dcmd_neon(playerid, params[]){
		...
		if(Vozidla(playerid) && GetPlayerState(playerid) == PLAYER_STATE_DRIVER) ShowPlayerDialog(playerid, DIALOG_MENU, DIALOG_STYLE_LIST, "TUNING", "{006600}N{ffffff}EONY\n{006600}S{ffffff}VETLA", "POTVRDIç", "ZAVRIEç");
		else SendClientMessage(playerid, FARBA_CERVENA, "[ ! ] {ffffff}NEM‘TE TUNOVAç NEKOMPATIBILN… VOZIDLO");
...
/**************************************************************************************************************************************/
	stock 
		...
		if(NEONY[playerid]) return SendClientMessage(playerid, FARBA_CERVENA,"[ ! ] {FFFFFF}Ué M¡TE NAMONTOVAN… NE”NY");
	...
	stock 
		...
		if(SVETLA[playerid]) return SendClientMessage(playerid, FARBA_CERVENA,"[ ! ] {FFFFFF}Ué M¡TE NAMONTOVAN… SVETL¡");
