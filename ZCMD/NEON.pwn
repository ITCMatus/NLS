...
/**************************************************************************************************************************************/
	CMD:neon(playerid,params[]){ 
		...
		else SendClientMessage(playerid, X11_RED, "[ ! ] {ffffff}NEM‘TE TUNOVAç NEKOMPATIBILN… VOZIDLO");
...
/**************************************************************************************************************************************/
	stock 
		...
		if(NEONY[playerid]) return SendClientMessage(playerid, X11_RED,"[ ! ] {FFFFFF}Ué M¡TE NAMONTOVAN… NE”NY");
	...
	stock 
		...
		if(SVETLA[playerid]) return SendClientMessage(playerid, X11_RED,"[ ! ] {FFFFFF}Ué M¡TE NAMONTOVAN… SVETL¡");
